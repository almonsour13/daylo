...
export default function ActivityPreviewDrawer({ children, activity }: Props) {
                    ...
                    <ColumnView className="gap-4">
                        <RowView className="justify-between">
                            ...
                            <RowView className="items-center">
                                ...
                                <TouchableOpacity
                                    className="hidden h-8 aspect-square justify-center items-center"
                                    onPress={
                                        handleDirectToActivityDetailsScreen
                                    }
                                >
                                    <Feather
                                        name="maximize-2"
